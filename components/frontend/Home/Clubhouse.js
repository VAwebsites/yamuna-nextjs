      ...
      <div className="container" id="pricing">
            ...
            <div className="row">
                    ...
                    <h2 style={{fontFamily:'Montserrat',color:'white',fontSize:'42px'}}>ClubHouse</h2>
                        <h2 style={{fontWeight:"600",fontSize:"1.3em",fontFamily:'Montserrat',lineHeight:'1.6em',color:'white'}}>One of its kind high end clubhouse giving a beautiful view of the surroundings. Facilitated with 7 luxury Suite Rooms, Cafe & Family Restaurant with Centralized AC.</h2>
